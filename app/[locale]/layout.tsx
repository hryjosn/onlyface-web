...
export const metadata: Metadata = {
  ...
  description:
    "Onlyface is a revolutionary app that redefines social networking through the power of beauty and community approval. Join a curated community of attractive individuals.",
  ...
  openGraph: {
    ...
    description:
      "Join Onlyface, the exclusive social network where beauty opens doors. Connect with genuine, verified individuals in a curated community.",
  ...
  twitter: {
    ...
    title: "Onlyface - Where Beauty Meets Approval!",
    description:
      "Redefining social networking through beauty and community approval.",
